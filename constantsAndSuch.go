...
var fileOfCards = []charSetStruct{
	...
	//
	{"ヒャ", "ひゃ", "hya", "hyaヒャ", "ひゃ",
		" hya:ひ:ヒ  a smiling mouth doing a hee-hee hi-hi",
		" hya, pronounced hee ",
		" TT: left-index > to the 'V' char",
		" ?:ひ:ヒ   '?'-man   TT: left-index > to the 'V' char"},
	{"ヒュ", "ひゅ", "hyu", "hyuヒュ", "ひゅ",
		" hyu:ひ:ヒ  a smiling mouth doing a hee-hee hi-hi",
		" hyu, pronounced hee ",
		" TT: left-index > to the 'V' char",
		" ?:ひ:ヒ   '?'-man   TT: left-index > to the 'V' char"},
	{"ヒョ", "ひょ", "hyo", "hyoヒョ", "ひょ",
		" hyo:ひ:ヒ  a smiling mouth doing a hee-hee hi-hi",
		" hyo, pronounced hee ",
		" TT: left-index > to the 'V' char",
		" ?:ひ:ヒ   '?'-man   TT: left-index > to the 'V' char"},
	//
	...
	{"ビャ", "びゃ", "bya", "byaビャ", "びゃ",
		" bya:ビ:び   hi-bi-pi ",
		" bya is from hi which looks like a smiling hi-hi びび",
		" TT: L-index to the 'V' char, plus a dakuten 濁点",
		" ?:ビ:び from hi, looks like smiling hi-hi びび   TT: L-index to 'V' char, plus a dakuten"},
	{"ビュ", "びゅ", "byu", "byuビュ", "びゅ",
		" byu:ビ:び   hi-bi-pi ",
		" byu is from hi which looks like a smiling hi-hi びび",
		" TT: L-index to the 'V' char, plus a dakuten 濁点",
		" ?:ビ:び from hi, looks like smiling hi-hi びび   TT: L-index to 'V' char, plus a dakuten"},
	{"ビョ", "びょ", "byo", "byoビョ", "びょ",
		" byo:ビ:び   hi-bi-pi ",
		" byo is from hi which looks like a smiling hi-hi びび",
		" TT: L-index to the 'V' char, plus a dakuten 濁点",
		" ?:ビ:び from hi, looks like smiling hi-hi びび   TT: L-index to 'V' char, plus a dakuten"},
	//
