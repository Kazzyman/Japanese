...
// **do-this** 1 : is the tag I have used to denote sections that I have yet to complete

import "fmt"

// used only in singleQuestMark() Question
// this func calls no other functions and sets no variables
func giveHintInResponseToDoubleQuestionMarksDir(key, value, Hint1k, Hint2k, Hint1h, Hint2h string) {
